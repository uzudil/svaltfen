            ...
            return {
                "": () => {
                    if(getGameState("malleus_dead") = true) {
                        return "You have returned from $Yrgalt! What $news do you bring of Malleus?";
                    } else {
                        return "I guess my $children failed to pursuade you to leave. Feel free to do so now. Where I'm going you can't possibly $follow.";
                    }
                },
                ...
                "news": "You have defeated Malleus? That is excellent news! I suppose he did not tell you the location of the $weapon he was planning on capturing?",
            };
        }
        return null;
    },
