     ...
     "onConvo": (self, n) => {
        if(n.name = "Aspect of Aiden") {
            return {
                ...
                "smell": "Well ok, not shmell technically, but let us not shplit hairsh. Let us just shay, you were recently on my $shide|side of the Fenshe, right?",
                ...
                "delivering": "You didn't laugh at my jokes. It's inshulting, shince I've been working on them for shuch a $long time.",
