...
const ITEMS = [
    ...
    { "name": "Ring of Protection", "img": "ring1", "description": "You're not sure how it works but slipping this ring on makes you feel safer.", "level": 5, "price": 75, "type": OBJECT_ARMOR, "slot": [ SLOT_RING1, SLOT_RING2 ], "ac": 1, },

    { "name": "Gold crown", "img": "crown", "description": "A valuable crown made of gold.", "level": 3, "price": 400, "type": OBJECT_ARMOR, "slot": SLOT_HEAD, "ac": 1, },
    ...
    { "name": "Small shield", "img": "shield1", "description": "This little buckler can be used to block your foe's attacks.", "level": 1, "price": 15, "type": OBJECT_ARMOR, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "ac": 1, },
    { "name": "Kite shield", "img": "shield2", "description": "You can still look impressive while you cower behind this decorative shield.", "level": 2, "price": 32, "type": OBJECT_ARMOR, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "ac": 2, },
    { "name": "Full shield", "img": "shield3", "description": "Also known as the tower shield. It is long enough to cover your entire body from attacks.", "level": 3, "price": 40, "type": OBJECT_ARMOR, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "ac": 3, },

    { "name": "Dagger", "img": "dagger", "description": "You must be brave to wield this glorified letter opener in combat.", "level": 1, "price": 7, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 2, 4 ] },
    { "name": "Small sword", "img": "sword1", "description": "Judging from the nicks, the business end of this stocky sword has seen some action.", "level": 2, "price": 8, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 3, 5 ] },
    { "name": "Soldier's sword", "img": "sword2", "description": "A standard soldier's bastard sword.", "level": 3, "price": 15, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 4, 8 ] },
    { "name": "Battle Axe", "img": "axe1", "description": "The standard issue battle axe is a popular way to end arguments.", "level": 3, "price": 16, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 5, 8 ] },
    { "name": "Warhammer", "img": "hammer", "description": "To put it bluntly, the war hammer leaves no room for subtlety.", "level": 4, "price": 15, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 5, 8 ] },
    { "name": "Morningstar", "img": "star", "description": "The morning star is the classic complement to a knight's sword.", "level": 4, "price": 14, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 4, 7 ] },
    { "name": "Rapier", "img": "sword4", "description": "The graceful pomel and long blade makes this sword the assassin's favorite weapon.", "level": 5, "price": 20, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 6, 8 ] },
    { "name": "Lance", "img": "lance1", "description": "The lance is basically a knife with a very long handle. Great at keeping trouble at bay.", "level": 3, "price": 15, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 4, 5 ] },
    { "name": "Short Axe", "img": "axe2", "description": "This axe is small enough to hide under clothing. Perfect for sneaking it into place where weapons are not allowed.", "level": 3, "price": 16, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 2, 6 ] },
    { "name": "Greatsword", "img": "sword3", "description": "This claymore is a heavy, two-handed beast of a blade.", "level": 5, "price": 42, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 6, 9 ] },
    { "name": "Greataxe", "img": "axe3", "description": "This two-handed axe is large and intimidating looking. Just holding it might be enough to avoid combat.", "level": 5, "price": 42, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 5, 10 ] },

    { "name": "Demonsbane Sword", "img": "sword5", "description": "A rather large sword, its pomel shaped like a screaming face.", "level": 6, "price": 800, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 4, 8 ], "bonus": 4, "bonusVs": "demon" },
    { "name": "Axe of Undeath", "img": "axe4", "description": "A rusty axe with a skull carved into its handle.", "level": 6, "price": 800, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 5, 8 ], "bonus": 3, "bonusVs": "undead" },
    { "name": "Lance of Aberrations", "img": "lance2", "description": "A silver lance decorated with a swirl pattern.", "level": 6, "price": 800, "type": OBJECT_WEAPON, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "dam": [ 4, 6 ], "bonus": 3, "bonusVs": "alien" },

    { "name": "Composite Bow", "img": "bow1", "description": "A small bow that is more powerful than it seems.", "level": 1, "price": 25, "type": OBJECT_WEAPON, "slot": SLOT_RANGED, "dam": [ 2, 4 ], "range": 6 },
    { "name": "Longbow", "img": "bow2", "description": "A simple and elegant weapon that, in the right hands, can shoot very far.", "level": 2, "price": 50, "type": OBJECT_WEAPON, "slot": SLOT_RANGED, "dam": [ 2, 5 ], "range": 6 },
    { "name": "Hunting bow", "img": "bow3", "description": "The master archer's tool for when precision is needed over all-out damage.", "level": 2, "price": 42, "type": OBJECT_WEAPON, "slot": SLOT_RANGED, "dam": [ 3, 5 ], "range": 6 },
    { "name": "Crossbow", "img": "bow4", "description": "Carrying one of these makes you look like you mean business.", "level": 3, "price": 75, "type": OBJECT_WEAPON, "slot": SLOT_RANGED, "dam": [ 2, 6 ], "range": 6 },
    { "name": "Heavy Crossbow", "img": "bow5", "description": "Heavy and slow to reload, but it shoots far and hard, not to mention how cool it looks.", "level": 4, "price": 120, "type": OBJECT_WEAPON, "slot": SLOT_RANGED, "dam": [ 3, 6 ], "range": 6 },
    { "name": "Throwing Knife", "img": "knife", "description": "Throwing knives don't do a lot of damage, but they're quick and keep the foes far away.", "level": 2, "price": 60, "type": OBJECT_WEAPON, "slot": SLOT_RANGED, "dam": [ 1, 2 ], "range": 3, "rangeBlocks": [ "knife", "knife2" ] },

    { "name": "Torch", "img": "torch", "description": "A lit torch for venturing below the earth.", "level": 1, "price": 2, "type": OBJECT_SUPPLIES, "slot": [ SLOT_LEFT_HAND, SLOT_RIGHT_HAND ], "light": 3 },
    { "name": "Lockpick", "img": "pick", "description": "Lockpicks can be used to open some locked doors.", "level": 1, "price": 3, "type": OBJECT_SUPPLIES, "use": (self, pc) => openLock() },
    { "name": "Rope", "img": "rope", "description": "A rope can be used to retrace your steps if you get lost underground.", "level": 1, "price": 4, "type": OBJECT_SUPPLIES, "use": (self, pc) => escapeCave() },
    { "name": "Gold ring", "img": "ring2", "description": "An unassuming, but probably valuable, gold ring.", "level": 3, "price": 200, "type": OBJECT_SUPPLIES, "slot": [ SLOT_RING1, SLOT_RING2 ] },
    { "name": "Diamond ring", "img": "ring3", "description": "A delicately crafted cradle holds a sizable diamond on this ring.", "level": 4, "price": 500, "type": OBJECT_SUPPLIES, "slot": [ SLOT_RING1, SLOT_RING2 ] },
    { "name": "Emerald ring", "img": "ring2", "description": "A small ring with a shiny emerald stone.", "level": 3, "price": 450, "type": OBJECT_SUPPLIES, "slot": [ SLOT_RING1, SLOT_RING2 ] },
    { "name": "Topaz ring", "img": "ring4", "description": "A brownish stone sits atop this ring.", "level": 4, "price": 300, "type": OBJECT_SUPPLIES, "slot": [ SLOT_RING1, SLOT_RING2 ] },
    { "name": "Ruby ring", "img": "ring1", "description": "The red stone of this ring glints like fire in the light.", "level": 4, "price": 450, "type": OBJECT_SUPPLIES, "slot": [ SLOT_RING1, SLOT_RING2 ] },
    { "name": "Large gemstone", "img": "gem1", "description": "A large, shiny gemstone.", "level": 5, "price": 500, "type": OBJECT_SUPPLIES },
    { "name": "Small gemstone", "img": "gem2", "description": "A small but beautiful gem.", "level": 2, "price": 50, "type": OBJECT_SUPPLIES },
    { "name": "Ancient coins", "img": "coin", "description": "These old coins might be worth some money.", "level": 3, "price": 400, "type": OBJECT_SUPPLIES },
    { "name": "Gold chains", "img": "chain1", "description": "A pretty, gold chain.", "level": 3, "price": 350, "type": OBJECT_SUPPLIES },
    { "name": "Silver chains", "img": "chain2", "description": "A light and graceful silver chain.", "level": 3, "price": 250, "type": OBJECT_SUPPLIES },
    { "name": "Ruby pin", "img": "pin", "description": "This decrative pin has some small rubies.", "level": 2, "price": 50, "type": OBJECT_SUPPLIES },
    ...
    { "name": "Ring of Light", "img": "ring5", "description": "This ring shines brightly like a torch.", "level": 1, "price": 2, "type": OBJECT_SPECIAL, "slot": [ SLOT_RING1, SLOT_RING2 ], "light": 3, "lightLife": -1 },    
];
